'''
this module builds AI model for predicting churn 
...
def encoder_helper(df, category_lst, response):
    ...
    for column in category_lst:
        encoded_column = column + '_' + response
...
def perform_feature_engineering(df, response):
    ...
    x_train, x_test, y_train, y_test = train_test_split(
        df[input_cols], df[response], test_size=0.3, random_state=42)
...
def classification_report_image(y_train,
    ...
    plt.text(
        0.01, 0.7, str(
            ...
            "fontsize": 10}, fontproperties="monospace")
    plt.axis("off")
    plt.savefig("images/results/classification_reports_rf.jpg")
    plt.close()

    # logisitic Regression Reports
    plt.figure("figure", figsize=(5, 5))
    ...
    plt.text(
        0.01, 0.7, str(
            ...
            "fontsize": 10}, fontproperties="monospace")
    plt.axis("off")
    plt.savefig("images/results/classification_reports_lr.jpg")
    plt.close()
...
def feature_importance_plot(model, x_data, output_pth):
    ...
    plt.savefig("images/%s/feature_importances.jpg" % output_pth)
...
if __name__ == '__main__':
    ...
    DF_RAW = import_data(r'data/bank_data.csv')
    ...
    logger.info('perform feature engineering and data split')
    X_TRAIN, X_TEST, Y_TRAIN, Y_TEST = perform_feature_engineering(
        DF_ENCODED, response='Churn')

    logger.info('train and store model, results')
